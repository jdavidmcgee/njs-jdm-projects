...
- npx prisma db push
- npx prisma generate (run this command if you change the schema)
...
- below this creates the instance 
- 'prisma' is what we have coded in utils/db.ts
- 'task' is the model name - in our project it is currently 'TestProfile'
- 'create' then needs the data - the id is generated automatically
```js
